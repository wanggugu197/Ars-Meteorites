...
public class MeteoriteRitualConfig {
    ...
    public static ModConfigSpec.IntValue BASE_RADIUS;
    public static ModConfigSpec.IntValue MAX_RADIUS;
    public static ModConfigSpec.BooleanValue METEORITR_WAY;

    public static ModConfigSpec.BooleanValue ENABLE_RECIPE;
    public static ModConfigSpec.BooleanValue ENABLE_DTAT_RECIPE;
